...
//        List<Shape> shapes1 = List.of(circle1);
//
//
//        System.out.println("shapeService.findBiggestArea(shapes) = " + shapeService.findBiggestArea(shapes));
//        System.out.println("shapeService.findBiggestCircumferenceByShape(shapes, type) = " + shapeService.findBiggestCircumferenceByShape(shapes, "circle"));
//
//        shapeService.exportShapes(shapes1, "src/test/resources/shapesForTest1.json");
//        shapeService.exportShapes(shapes, "src/test/resources/shapesForTest.json");
